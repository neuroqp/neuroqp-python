...
Download the [synthetic v2 export](../assets/downloads/neuroqp-example-v2.zip) or use a ZIP exported from NeuroQP.
...
Continue with the [object-navigation guide](../guides/navigation.md) or run the [executable notebooks](../examples/index.md).
